...
*Numeric Variable Processing:* Outliers (defined as values \< Q1- 1.5*IQR or \> Q3+1.5*IQR) were removed. Numeric variables were subsequently log-transformed (after adding 1 to each value) to make them approximately log-normal (see histograms below).
...
| **LBXBPB_clean_log**   | 0.68   | 0.25  | 0.66   | 0.11  | 1.33  |
| **LBXBCD_clean_log**   | 0.07   | 0.17  | 0.26   | 0.07  | 0.79   |
| **LBXBMN_clean_log**   | 2.33  | 0.28  | 2.33   | 1.40  | 2.96  |
| **BPXSY1_clean**   | 126.18 | 15.69 | 125.60 | 88.00 | 170.00 |
| **BPXDI1_clean**   | 76.00  | 9.69 | 75.94  | 52.00  | 100.00 |
...
| Female                              | 821 (51.63%)   |
| **RIDRETH1: Race**                  |                 |
| Mexican American                    | 249 (15.66%)    |
| Other Hispanic                      | 179 (11.25%)    |
| Non-Hispanic White                  | 459 (28.87%)    |
| Non-Hispanic Black                  | 376 (23.64%)    |
| Other Race - Including Multi-Racial | 327 (20.57%)    |

## Codebook (HTML Rendering)
Check out HTML codebook <a href="/data/study1/codebook.html">here &rarr;</a> 
